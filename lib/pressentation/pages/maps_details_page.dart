      ...
      body: Stack(
        children: [
          FlutterMap(
            ...
            options: MapOptions(
              onMapReady: () {
                _mapController.move(LatLng(51.0, -0.09), 13.0);
              },
            ),
            children: [
              TileLayer(
      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              SizedBox(height: 20,),
              Text('${car.model}', style: TextStyle(fontSize: 24,
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text('\$${car.pricePerHour}/day',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 22),),
        ...
        Positioned(
          top: 20,
          right: -10,
            child: Image.asset('assets/onboardingcar2.png'), width: 220,height: 160,)
